...
export type EventManyWhereInput = {
  ...
  /** All values starting with the given string. */
  id_starts_with?: InputMaybe<Scalars['ID']>;
  logoEvent?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  logoEvent_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  logoEvent_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  logoEvent_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  logoEvent_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  logoEvent_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  logoEvent_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  logoEvent_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  logoEvent_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  logoEvent_starts_with?: InputMaybe<Scalars['String']>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export enum EventOrderByInput {
  ...
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  LogoEventAsc = 'logoEvent_ASC',
  LogoEventDesc = 'logoEvent_DESC',
  PublishedAtAsc = 'publishedAt_ASC',
  PublishedAtDesc = 'publishedAt_DESC',
  TitleAsc = 'title_ASC',
...
export type ScheduledOperationAffectedDocument = Asset | Challenge | Event | Lesson | Subscriber | Teacher;
